...
function closeGalleryModal() {
    ...
    // --- NOVA LÓGICA: Sincronizar carrossel de fundo com a imagem do modal ---
    const mainTrack = document.getElementById('planeCarousel');
    if (mainTrack) {
        // Pega a largura do slide do carrossel principal
        const slideWidth = mainTrack.clientWidth; 
        
        // Rola o carrossel principal exatamente para a posição da foto que estava no modal
        mainTrack.scrollTo({
            left: slideWidth * currentModalIndex,
            behavior: 'auto' // 'auto' para ser instantâneo, ou mude para 'smooth' se quiser animação
        });
    }
}
...
if (leadForm) {
    leadForm.addEventListener('submit', async (e) => {
        ...
        const formData = {
            ...
            interesse: document.getElementById('interesse')?.value || '', // Optional chaining adicionado por segurança
        ...
        const webhookURL = 'https://hook.us1.make.com/m0kxia0k74ibwhypt75ipryrvsnl6g9e'; 
        ...
        try {
            ...
            btnText.innerText = 'Agendar Minha Consultoria'; // Ajustado para o texto que estava no seu catch (ou mude para 'Enviar')
