...
/* ================================================================
   4. ANIMAÇÃO PARALAXE CIRRUS GSAP
   ================================================================ */
function iniciarAnimacaoCirrus() {
  ...
  if (!canvas) return; // Se a tela não tiver o canvas (outra página), não roda o script
  ...
  // Reseta estado para evitar "pulos" antes do scroll
  ...
  // Faz o "Pin" correto: trava a tela até rodar os 400% de scroll, depois libera
